...
function [] = CSE_QRS_tester_1svod_v0()
...
for cislo = cisla
    ...
    for i = 1:pocet_svodu % pozn.: jen jeden svod
        ...
        QRS = detectQRS(x(i,:),fvz); % detekce QRS prahovanim puvodniho EKG
        ...
        [TP,FP,FN]= SeP(QRS,poziceQRSvCSEv2{cislo,1},tol);
...
%------ POMOCNÉ FUNKCE ----------------------------------------------------
function [TP,FP,FN]= SeP(QRS,refQRS,tol)
TP = 0;
FP = 0;
FN = 0;
